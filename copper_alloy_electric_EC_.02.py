...
kernel = RBF(length_scale=.02) + WhiteKernel()
...
plt.xlabel("Experimental Electrical Conductivity (%IACS)", fontsize=14)
...
plt.text(0.05, 0.85, f'MAE: {mae:.2f} (%IACS)', transform=plt.gca().transAxes, fontsize=12)
